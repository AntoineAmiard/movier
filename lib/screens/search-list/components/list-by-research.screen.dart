...
class ListByResearch extends StatelessWidget {
  final String mediaType;
  final List<Media> medias;

  ListByResearch({this.mediaType, this.medias});

  factory ListByResearch.fromMovie({List<MovieOverview> movies}) {
    return ListByResearch(
      medias: movies
          .map(
  ...
  factory ListByResearch.fromTv({List<TvOverview> tvs}) {
    return ListByResearch(
      medias: tvs
